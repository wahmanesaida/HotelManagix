    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form action="{{url('admin/aboutpage/'.$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            <th>Presentation</th>
                            <td><textarea name="description1" class="form-control" cols="30" rows="2" >{{$data->description1}}</textarea></td>
                        </tr>
                        <tr>
                            <th>Description</th>
                            <td><textarea name="description2" class="form-control" cols="30" rows="2" >{{$data->description2}}</textarea></td>
                        </tr>
                        <tr>
                            <th>Photo1</th>
