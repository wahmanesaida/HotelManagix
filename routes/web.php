...
Route::get('/payment/success', [InvoiceUserController::class, 'paymentSuccess'])->name('paymentuser.success');
Route::get('/payment/fail', [InvoiceUserController::class, 'paymentFail'])->name('paymentuser.fail');
